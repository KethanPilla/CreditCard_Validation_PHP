    ...
    <body>
                            ...
                            <div class="card-body">
                                ...
                                <div class="text-center">
                                    ...
                                    <div class="d-flex flex-column mb-4">
                                        <span class="h1 mb-0">6.9″</span>
                                        <span>Super Retina XDR display1</span>
                                        <span>ProMotion technology</span>
                            ...
                            <div class="card-body">
                                ...
                                <div class="text-center">
                                    ...
                                    <div class="d-flex flex-column mb-4">
                                        ...
                                        <ul class="list-unstyled mb-0">
                                            <li aria-hidden="true">—</li>
                                            <li aria-hidden="true">24MP Ultra Wide</li>
                                            <li>48MP Fusion</li>
                                            <li>—</li>
                                            <li aria-hidden="true">—</li>
                                        </ul>
                            ...
                            <div class="card-body">
                                ...
                                <div class="text-center">
                                    ...
                                    <div class="d-flex flex-column mb-4">
                                        ...
                                        <ul class="list-unstyled mb-0">
                                            <li aria-hidden="true">48MP Ultra Wide</li>
                                            <li>48MP Fusion</li>
                                            <li>—</li>
                                            <li aria-hidden="true">—</li>
                                        </ul>
        ...
        <section>
            ...
            <form action = "orderSummary.php" method = "POST">
                ...
                <br>
                <label for="storage">Choose the storage size:</label>
